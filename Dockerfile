...
LABEL org.opencontainers.image.source="https://github.com/floriandejonckheere/my-app"

ENV RUNTIME_DEPS="postgresql tzdata"
ENV BUILD_DEPS="build-base curl-dev git postgresql-dev cmake nodejs-current npm yaml-dev"
